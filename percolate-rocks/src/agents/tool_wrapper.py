...
def create_pydantic_tool(mcp_tool_func: Callable) -> Tool:
    ...
    Example:
        from src.mcp_tools import search_memory
    ...
    for name, param in sig.parameters.items():
        ...
        # Use parameter name as description (TODO: extract from docstring)
...
def _python_type_to_json_type(python_type: Any) -> str:
    ...
    # TODO: Handle Union, Optional, List, Dict properly using Pydantic
    return "string"
